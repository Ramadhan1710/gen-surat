...
class SusunanPengurusIpnuMapper {
  static SusunanPengurusIpnuEntity toEntity(
    SusunanPengurusIpnuModel model,
  ) {
    return SusunanPengurusIpnuEntity(
      ...
      pembina: model.pembina
          .map(
            (pembina) => PembinaEntity(
              no: pembina.no,
              nama: pembina.nama,
            ),
          )
  ...
  static SusunanPengurusIpnuModel toModel(
    ...
    return SusunanPengurusIpnuModel(
      ...
      pembina: entity.pembina
          .map(
            (pembina) => PembinaModel(
              no: pembina.no,
              nama: pembina.nama,
            ),
          )
