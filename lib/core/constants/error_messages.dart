class ErrorMessages {
  ...
  // Network errors
  static const String connectionTimeout = 'Koneksi timeout. Pastikan internet Anda stabil.';
  static const String serverError = 'Server terlalu lama merespon. Coba lagi nanti.';
