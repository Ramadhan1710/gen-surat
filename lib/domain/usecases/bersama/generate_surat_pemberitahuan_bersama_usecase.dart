...
import 'package:gen_surat/data/mappers/bersama/surat_pemberitahuan_bersama_mapper.dart';
...
class GenerateSuratPemberitahuanBersamaUsecase {
  final ISuratRepository repository;

  GenerateSuratPemberitahuanBersamaUsecase(this.repository);

  Future<File> execute(
    SuratPemberitahuanBersamaEntity entity, {
    ...
    final model = SuratPemberitahuanBersamaMapper.toModel(entity);

    return await repository.generateSurat(
      data: model,
      jenisSurat: AppConstants.lembagaBersama,
      typeSurat: TypeSuratConstants.suratPemberitahuanBersama,
      endpoint: ApiConstants.suratPemberitahuan,
  ...
  void _validateEntity(SuratPemberitahuanBersamaEntity entity) {
