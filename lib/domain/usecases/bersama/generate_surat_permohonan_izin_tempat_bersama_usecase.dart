...
import 'package:gen_surat/data/mappers/bersama/surat_permohonan_izin_tempat_bersama_mapper.dart';
...
class GenerateSuratPermohonanIzinTempatBersamaUsecase {
  final ISuratRepository repository;

  GenerateSuratPermohonanIzinTempatBersamaUsecase(this.repository);

  Future<File> execute(
    SuratPermohonanIzinTempatBersamaEntity entity, {
    ...
    final model = SuratPermohonanIzinTempatBersamaMapper.toModel(entity);

    return await repository.generateSurat(
      data: model,
      jenisSurat: AppConstants.lembagaBersama,
      typeSurat: TypeSuratConstants.suratPermohonanIzinTempatBersama,
      endpoint: ApiConstants.suratPermohonanIzinTempat,
  ...
  void _validateEntity(SuratPermohonanIzinTempatBersamaEntity entity) {
