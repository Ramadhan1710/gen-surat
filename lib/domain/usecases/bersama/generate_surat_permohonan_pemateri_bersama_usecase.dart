...
import 'package:gen_surat/data/mappers/bersama/surat_permohonan_pemateri_bersama_mapper.dart';
...
class GenerateSuratPermohonanPemateriBersamaUsecase {
  final ISuratRepository repository;

  GenerateSuratPermohonanPemateriBersamaUsecase(this.repository);

  Future<File> execute(
    SuratPermohonanPemateriBersamaEntity entity, {
    ...
    final model = SuratPermohonanPemateriBersamaMapper.toModel(entity);

    return await repository.generateSurat(
      data: model,
      jenisSurat: AppConstants.lembagaBersama,
      typeSurat: TypeSuratConstants.suratPermohonanPemateriBersama,
      endpoint: ApiConstants.suratPermohonanPemateriBersama,
  ...
  void _validateEntity(SuratPermohonanPemateriBersamaEntity entity) {
