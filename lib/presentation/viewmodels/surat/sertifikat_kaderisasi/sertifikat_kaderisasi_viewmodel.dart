  ...
  bool _validateForm() {
    ...
    if (!validateForm()) {
      ...
      final lembagaValidation = formValidator.validateLembagaInfo(
        ...
        periodeKepengurusan:
            formDataManager.periodeKepengurusanController.text.trim(),
      );
    ...
    final sertifikatValidation = formValidator.validateSertifikatFiles(
      ...
      sertifikatSekretarisPath:
          formDataManager.sertifikatKaderisasiSekretarisPath,
      sertifikatBendaharaPath:
          formDataManager.sertifikatKaderisasiBendaharaPath,
    );

    if (!sertifikatValidation.isValid) {
      handleValidationError(
        ValidationException(
          sertifikatValidation.errorMessage ?? 'Validasi gagal',
        ),
      );
      return false;
    }
