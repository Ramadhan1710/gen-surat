...
class CurriculumVitaeStepNavigationManager {
  ...
  bool get canGoNext => currentStep.value.index < CurriculumVitaeFormStep.values.length - 1;
  
  bool get isLastStep => currentStep.value == CurriculumVitaeFormStep.values.last;

  void nextStep() {
    if (canGoNext) {
      currentStep.value = CurriculumVitaeFormStep.values[currentStep.value.index + 1];
    }
  }
