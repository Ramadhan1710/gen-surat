...
import 'package:gen_surat/presentation/viewmodels/surat/bersama/pemberitahuan/managers/surat_pemberitahuan_bersama_form_validator.dart';
import 'package:gen_surat/presentation/viewmodels/surat/bersama/pemberitahuan/managers/surat_pemberitahuan_bersama_step_navigation_manager.dart';
import 'package:gen_surat/presentation/viewmodels/surat/bersama/undangan/enum/surat_undangan_bersama_form_step.dart';
import 'package:get/get.dart';

class SuratPemberitahuanBersamaViewmodel extends BaseSuratViewModel {
  final GenerateSuratPemberitahuanBersamaUsecase
  _generateSuratPemberitahuanBersamaUsecase;

  final SuratPemberitahuanBersamaFormDataManager formDataManager;
  final SuratPemberitahuanBersamaFormValidator formValidator;
  final SuratPemberitahuanBersamaStepNavigationManager stepNavigationManager;

  SuratPemberitahuanBersamaViewmodel(
    this._generateSuratPemberitahuanBersamaUsecase,
    IGeneratedFileRepository fileRepository,
    NotificationService notificationService,
    FileOperationService fileOperationService,
  ) : formDataManager = SuratPemberitahuanBersamaFormDataManager(),
      formValidator = SuratPemberitahuanBersamaFormValidator(),
      stepNavigationManager = SuratPemberitahuanBersamaStepNavigationManager(),
      super(
  ...
  Rx<SuratPemberitahuanBersamaFormStep> get currentStep =>
      stepNavigationManager.currentStep;
  int get totalSteps => SuratPemberitahuanBersamaFormStep.totalSteps;
  List<String> get stepTitles => SuratPemberitahuanBersamaFormStep.allTitles;

  @override
  String get fileType => 'pemberitahuan_bersama';
  ...
  Future<void> generateSurat({String? jenisSurat, String? endpoint}) async {
    ...
    try {
      ...
      final file = await _generateSuratPemberitahuanBersamaUsecase.execute(
  ...
  Map<SuratPemberitahuanBersamaFormStep, List<FocusErrorField>>
  get _stepErrorFields => {
    ...
    SuratPemberitahuanBersamaFormStep.isi: [
      FocusErrorField(
    ...
    SuratPemberitahuanBersamaFormStep.penutup: [
      FocusErrorField(
