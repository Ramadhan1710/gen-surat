...
import 'package:gen_surat/presentation/viewmodels/surat/bersama/undangan/managers/surat_undangan_bersama_form_data_manager.dart';
import 'package:gen_surat/presentation/viewmodels/surat/bersama/undangan/managers/surat_undangan_bersama_form_validator.dart';
import 'package:gen_surat/presentation/viewmodels/surat/bersama/undangan/managers/surat_undangan_bersama_step_navigation_manager.dart';
import 'package:get/get.dart';

class SuratUndanganBersamaViewmodel extends BaseSuratViewModel {
  final GenerateSuratUndanganBersamaUsecase
  _generateSuratUndanganBersamaUsecase;

  final SuratUndanganBersamaFormDataManager formDataManager;
  final SuratUndanganBersamaFormValidator formValidator;
  final SuratUndanganBersamaStepNavigationManager stepNavigationManager;

  SuratUndanganBersamaViewmodel(
    this._generateSuratUndanganBersamaUsecase,
    IGeneratedFileRepository fileRepository,
    NotificationService notificationService,
    FileOperationService fileOperationService,
  ) : formDataManager = SuratUndanganBersamaFormDataManager(),
      formValidator = SuratUndanganBersamaFormValidator(),
      stepNavigationManager = SuratUndanganBersamaStepNavigationManager(),
      super(
  ...
  Rx<SuratUndanganBersamaFormStep> get currentStep =>
      stepNavigationManager.currentStep;
  int get totalSteps => SuratUndanganBersamaFormStep.totalSteps;
  List<String> get stepTitles => SuratUndanganBersamaFormStep.allTitles;

  @override
  String get fileType => 'undangan_bersama';
  ...
  Future<void> generateSurat({String? jenisSurat, String? endpoint}) async {
    ...
    try {
      ...
      final file = await _generateSuratUndanganBersamaUsecase.execute(
  ...
  Map<SuratUndanganBersamaFormStep, List<FocusErrorField>>
  get _stepErrorFields => {
    ...
    SuratUndanganBersamaFormStep.isi: [
      FocusErrorField(
    ...
    SuratUndanganBersamaFormStep.penutup: [
      FocusErrorField(
