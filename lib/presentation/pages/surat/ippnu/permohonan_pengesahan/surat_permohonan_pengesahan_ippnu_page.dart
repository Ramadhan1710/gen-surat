...
import 'package:gen_surat/presentation/pages/surat/ippnu/permohonan_pengesahan/widgets/step_lembaga_section_ippnu.dart';
import 'package:gen_surat/presentation/pages/surat/ippnu/permohonan_pengesahan/widgets/step_surat_section_ippnu.dart';
import 'package:gen_surat/presentation/pages/surat/ippnu/permohonan_pengesahan/widgets/step_kepengurusan_section_ippnu.dart';
import 'package:gen_surat/presentation/pages/surat/ippnu/permohonan_pengesahan/widgets/step_tanda_tangan_section_ippnu.dart';
import 'package:get/get.dart';
import 'package:gen_surat/presentation/viewmodels/surat/ippnu/permohonan_pengesahan/enum/surat_permohonan_pengesahan_ippnu_form_step.dart';

class SuratPermohonanPengesahanIppnuPage extends StatelessWidget {
  const SuratPermohonanPengesahanIppnuPage({super.key});

  @override
  Widget build(BuildContext context) {
    final vm = Get.find<SuratPermohonanPengesahanIppnuViewmodel>();
  ...
  AppBar _buildAppBar(
    ...
    SuratPermohonanPengesahanIppnuViewmodel vm,
  ) {
    return AppBar(
      title: const Text('Surat Permohonan Pengesahan IPPNU'),
      actions: [
        IconButton(
  ...
  Widget _buildStepContent(SuratPermohonanPengesahanIppnuViewmodel vm) {
    switch (vm.currentStep.value) {
      case SuratPermohonanPengesahanIppnuFormStep.lembaga:
        return StepLembagaSectionIppnu(viewModel: vm);
      case SuratPermohonanPengesahanIppnuFormStep.surat:
        return StepSuratSectionIppnu(viewModel: vm);
      case SuratPermohonanPengesahanIppnuFormStep.kepengurusan:
        return StepKepengurusanSectionIppnu(viewModel: vm);
      case SuratPermohonanPengesahanIppnuFormStep.tandaTangan:
        return StepTandaTanganSectionIppnu(viewModel: vm);
    }
  }
  ...
  Widget _buildErrorSection(SuratPermohonanPengesahanIppnuViewmodel vm) {
    return Obx(() {
