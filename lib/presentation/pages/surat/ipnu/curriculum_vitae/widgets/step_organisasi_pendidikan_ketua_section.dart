...
class StepOrganisasiPendidikanKetuaSection extends StatelessWidget {
  final CurriculumVitaeIpnuViewmodel viewModel;

  const StepOrganisasiPendidikanKetuaSection({
    super.key,
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        const SectionHeader(title: 'Pengalaman Organisasi & Pendidikan Ketua'),
    ...
    return Column(
      ...
      children: [
        ...
        Obx(() {
          ...
          viewModel.organisasiKetuaVersion.value;

          return SwitchListTile(
            value: viewModel.formDataManager.hasNoOrganizationKetua,
            onChanged: viewModel.toggleNoOrganizationKetua,
        ...
        Obx(() {
          ...
          final organisasiList = viewModel.formDataManager.organisasiKetuaList;
          final hasNoOrganization =
              viewModel.formDataManager.hasNoOrganizationKetua;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomTextField(
                          ...
                          helpText: 'Contoh: Ketua OSIS SMA Negeri 1 Mojosari',
                          icon: Icons.business, 
        ...
        Obx(() {
          viewModel.organisasiKetuaVersion.value;
          if (viewModel.formDataManager.hasNoOrganizationKetua) {
            return SizedBox.shrink();
          }
          return OutlinedButton.icon(
            onPressed: viewModel.addOrganisasiKetua,
  ...
  Widget _buildPendidikanSection(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Obx(() {
          // Trigger rebuild when version changes
          viewModel.pendidikanKetuaVersion.value;

          final pendidikanList = viewModel.formDataManager.pendidikanKetuaList;
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          IconButton(
                            onPressed:
                                () => viewModel.removePendidikanKetua(index),
                            icon: const Icon(Icons.delete_outline),
                            color: Theme.of(context).colorScheme.error,
                            tooltip: 'Hapus',
                          ),
        ...
        Obx(() {
          viewModel.pendidikanKetuaVersion.value;
          return OutlinedButton.icon(
            onPressed: viewModel.addPendidikanKetua,
            icon: const Icon(Icons.add),
