...
class StepOrganisasiPendidikanBendaharaSection extends StatelessWidget {
  final CurriculumVitaeIpnuViewmodel viewModel;

  const StepOrganisasiPendidikanBendaharaSection({
    super.key,
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        const SectionHeader(title: 'Pengalaman Organisasi & Pendidikan Bendahara'),
    ...
    return Column(
      ...
      children: [
        ...
        Obx(() {
          ...
          viewModel.organisasiBendaharaVersion.value;

          return SwitchListTile(
            value: viewModel.formDataManager.hasNoOrganizationBendahara,
            onChanged: viewModel.toggleNoOrganizationBendahara,
            // title: const Text('Tidak ada pengalaman organisasi'),
            subtitle: Text(
              'Aktifkan jika bendahara belum memiliki pengalaman organisasi',
              style: TextStyle(
                fontSize: 12,
        ...
        Obx(() {
          ...
          final organisasiList = viewModel.formDataManager.organisasiBendaharaList;
          final hasNoOrganization =
              viewModel.formDataManager.hasNoOrganizationBendahara;
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            IconButton(
                              onPressed:
                                  () => viewModel.removeOrganisasiBendahara(index),
                        ...
                        CustomTextField(
                          ...
                          helpText: 'Contoh: Bendahara OSIS SMA Negeri 1 Mojosari',
                          icon: Icons.business, 
        ...
        Obx(() {
          viewModel.organisasiBendaharaVersion.value;
          if (viewModel.formDataManager.hasNoOrganizationBendahara) {
            return SizedBox.shrink();
          }
          return OutlinedButton.icon(
            onPressed: viewModel.addOrganisasiBendahara,
  ...
  Widget _buildPendidikanSection(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Obx(() {
          // Trigger rebuild when version changes
          viewModel.pendidikanBendaharaVersion.value;

          final pendidikanList = viewModel.formDataManager.pendidikanBendaharaList;
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          IconButton(
                            onPressed:
                                () => viewModel.removePendidikanBendahara(index),
                            icon: const Icon(Icons.delete_outline),
                            color: Theme.of(context).colorScheme.error,
                            tooltip: 'Hapus',
                          ),
        ...
        Obx(() {
          viewModel.pendidikanBendaharaVersion.value;
          return OutlinedButton.icon(
            onPressed: viewModel.addPendidikanBendahara,
            icon: const Icon(Icons.add),
