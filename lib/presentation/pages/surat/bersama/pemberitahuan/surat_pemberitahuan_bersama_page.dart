...
import 'package:gen_surat/presentation/pages/surat/bersama/pemberitahuan/widgets/step_isi_section.dart';
import 'package:gen_surat/presentation/pages/surat/bersama/pemberitahuan/widgets/step_pembuka_section.dart';
import 'package:gen_surat/presentation/pages/surat/bersama/pemberitahuan/widgets/step_penutup_section.dart';
...
class SuratPemberitahuanBersamaPage extends StatelessWidget {
  const SuratPemberitahuanBersamaPage({super.key});

  @override
  Widget build(BuildContext context) {
    final vm = Get.find<SuratPemberitahuanBersamaViewmodel>();
  ...
  AppBar _buildAppBar(
    ...
    SuratPemberitahuanBersamaViewmodel vm,
  ) {
    return AppBar(
      title: const Text('Form Surat Pemberitahuan Bersama'),
      actions: [
        IconButton(
  ...
  Widget _buildStepContent(SuratPemberitahuanBersamaViewmodel vm) {
  ...
  Widget _buildErrorSection(SuratPemberitahuanBersamaViewmodel vm) {
    return Obx(() {
