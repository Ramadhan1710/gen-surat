...
import 'package:gen_surat/presentation/pages/surat/bersama/permohonan_pemateri/widgets/step_isi_section.dart';
import 'package:gen_surat/presentation/pages/surat/bersama/permohonan_pemateri/widgets/step_penutup_section.dart';
import 'package:gen_surat/presentation/pages/surat/bersama/permohonan_pemateri/widgets/step_pembuka_section.dart';
...
class SuratPermohonanPemateriBersamaPage extends StatelessWidget {
  const SuratPermohonanPemateriBersamaPage({super.key});

  @override
  Widget build(BuildContext context) {
    final vm = Get.find<SuratPermohonanPemateriBersamaViewmodel>();
  ...
  AppBar _buildAppBar(
    ...
    SuratPermohonanPemateriBersamaViewmodel vm,
  ) {
    return AppBar(
      title: const Text('Form Surat Permohonan Pemateri Bersama'),
      actions: [
        IconButton(
  ...
  Widget _buildStepContent(SuratPermohonanPemateriBersamaViewmodel vm) {
  ...
  Widget _buildErrorSection(SuratPermohonanPemateriBersamaViewmodel vm) {
    return Obx(() {
