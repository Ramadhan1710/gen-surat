...
import 'package:gen_surat/presentation/pages/surat/bersama/dispensasi/widgets/step_isi_section.dart';
import 'package:gen_surat/presentation/pages/surat/bersama/dispensasi/widgets/step_pembuka_section.dart';
import 'package:gen_surat/presentation/pages/surat/bersama/dispensasi/widgets/step_penutup_section.dart';
...
class SuratDispensasiBersamaPage extends StatelessWidget {
  const SuratDispensasiBersamaPage({super.key});

  @override
  Widget build(BuildContext context) {
    final vm = Get.find<SuratDispensasiBersamaViewmodel>();
  ...
  AppBar _buildAppBar(
    ...
    SuratDispensasiBersamaViewmodel vm,
  ) {
    return AppBar(
  ...
  Widget _buildStepContent(SuratDispensasiBersamaViewmodel vm) {
    switch (vm.currentStep.value) {
      case SuratDispensasiBersamaFormStep.pembuka:
        return StepPembukaSection(viewModel: vm);
      case SuratDispensasiBersamaFormStep.isi:
        return StepIsiSection(viewModel: vm);
      case SuratDispensasiBersamaFormStep.penutup:
  ...
  Widget _buildErrorSection(SuratDispensasiBersamaViewmodel vm) {
    return Obx(() {
