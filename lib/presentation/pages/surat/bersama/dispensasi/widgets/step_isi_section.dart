...
class StepIsiSection extends StatelessWidget {
  final SuratDispensasiBersamaViewmodel viewModel;
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: AppDimensions.spaceM),
        CustomTextField(
          controller: viewModel.formDataManager.namaController,
          focusNode: viewModel.formDataManager.namaFocus,
          label: 'Nama *',
          helpText: 'Contoh: M. Ainur Ramadhan',
          hint: 'Masukkan nama',
          textCapitalization: TextCapitalization.words,
          textInputAction: TextInputAction.next,
          icon: Icons.person,
        ...
        const SizedBox(height: AppDimensions.spaceM),
        CustomTextField(
          controller: viewModel.formDataManager.kelasSekolahController,
          focusNode: viewModel.formDataManager.kelasSekolahFocus,
          label: 'Kelas dan Sekolah *',
          helpText: 'Contoh: XII MIPA 1 / MA NU Mojosari',
          hint: 'Masukkan nama kelas dan sekolah',
          textCapitalization: TextCapitalization.words,
          textInputAction: TextInputAction.done,
          icon: Icons.account_balance,
          validator: UiFieldValidators.required('Kelas dan sekolah'),
        ),
