...
import 'package:gen_surat/presentation/pages/surat/bersama/undangan/widgets/step_isi_section.dart';
import 'package:gen_surat/presentation/pages/surat/bersama/undangan/widgets/step_pembuka_section.dart';
import 'package:gen_surat/presentation/pages/surat/bersama/undangan/widgets/step_penutup_section.dart';
...
class SuratUndanganBersamaPage extends StatelessWidget {
  const SuratUndanganBersamaPage({super.key});

  @override
  Widget build(BuildContext context) {
    final vm = Get.find<SuratUndanganBersamaViewmodel>();
  ...
  AppBar _buildAppBar(
    ...
    SuratUndanganBersamaViewmodel vm,
  ) {
    return AppBar(
  ...
  Widget _buildStepContent(SuratUndanganBersamaViewmodel vm) {
    switch (vm.currentStep.value) {
      case SuratUndanganBersamaFormStep.pembuka:
        return StepPembukaSection(viewModel: vm);
      case SuratUndanganBersamaFormStep.isi:
        return StepIsiSection(viewModel: vm);
      case SuratUndanganBersamaFormStep.penutup:
  ...
  Widget _buildErrorSection(SuratUndanganBersamaViewmodel vm) {
    return Obx(() {
